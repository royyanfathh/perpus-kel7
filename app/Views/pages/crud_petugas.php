    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <?php echo form_open_multipart(base_url('Petugas/Add')) ?>
...
<?php foreach ($petugas as $key => $value) { ?> 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <?php echo form_open(base_url('Petugas/EditData/'.$value['id'])) ?>
               <div class="form-group">
                <label>Nama Petugas</label>
                <input type="text" class="form-control" value="<?= $value['nama'] ?>" name="nama" placeholder="Nama Petugas" required>
                <label>Jenis Kelamin</label>
   ...
   <div class="modal fade" id="modal-delete<?= $value['id'] ?>">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <?php echo form_open(base_url('Petugas/DeleteData/'.$value['id'])) ?>
               <div class="form-group">
