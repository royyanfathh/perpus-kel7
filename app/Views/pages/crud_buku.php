                            ...
                            <tbody>
                                ...
                                foreach ($buku as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="<?= base_url('images/' . $value['foto_buku']) ?>"
                                                alt="user-avatar" class="img-fluid"></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                                data-target="#modal-delete<?= $value['id'] ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>foto_buku</label>
                        <input type="file" class="form-control" value="<?= $value['foto_buku'] ?>" name="foto_buku"
                            placeholder="foto_buku" required>
                        <label>Judul</label>
                        <input type="text" class="form-control" value="<?= $value['judul'] ?>" name="judul"
                            placeholder="judul" required>
                        <label>Tahun</label>
                        <input type="text" class="form-control" value="<?= $value['tahun'] ?>" name="tahun"
                            placeholder="tahun" required>
                        <label>Jumlah</label>
                        <input type="text" class="form-control" value="<?= $value['jumlah'] ?>" name="jumlah"
                            placeholder="jumlah" required>
                        <label>Lokasi</label>
                        <input type="text" class="form-control" value="<?= $value['lokasi'] ?>" name="lokasi"
